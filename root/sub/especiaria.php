        ...
        <div>
          <ul>
            ...
            <li><a href="index.php?page=fruta">Frutas</a></li>
            <li><a href="index.php?page=especiaria" class="active">Especiarias</a></li>
          </ul>
        </div>

  <?php
  $postagem = mysql_query("SELECT * FROM planta WHERE categoria='Especiaria' ORDER BY id DESC");
